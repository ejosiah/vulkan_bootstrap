...
namespace phong{
    ...
    inline void load(const std::string& path, VulkanDevice &device, const VulkanDescriptorPool& pool,
        ...
        drawable.shadowMapDescriptorSetLayout = device.createDescriptorSetLayout(bindings);
        ...
        for(int i = 0; i < meshes.size(); i++){
            ...
            drawable.meshes[i].material.init(mesh, device, pool, drawable.shadowMapDescriptorSetLayout, info.materialUsage);
