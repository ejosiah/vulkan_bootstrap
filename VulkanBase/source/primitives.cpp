...
Vertices primitives::cube(const glm::vec4& color){
    ...
    mesh.vertices = {
            ...
            // FRONT FACE
            {{-0.5, -0.5, 0.5, 1}, color, {0.0f, 0.0f, 1.0f}, {0, 0, 0}, {0, 0, 0},  {0, 0}},
            {{0.5, -0.5, 0.5, 1}, color,  {0.0f, 0.0f, 1.0f}, {0, 0, 0}, {0, 0, 0}, {1, 0}},
            {{0.5, 0.5, 0.5, 1}, color,  {0.0f, 0.0f, 1.0f}, {0, 0, 0}, {0, 0, 0}, {1, 1}},
            {{-0.5, 0.5, 0.5, 1}, color,  {0.0f, 0.0f, 1.0f}, {0, 0, 0}, {0, 0, 0}, {0, 1}},

            // RIGHT FACE
            {{0.5, -0.5, 0.5, 1}, color,  {1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0}, {0, 0}},
            {{0.5, -0.5, -0.5, 1}, color,  {1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0}, {1, 0}},
            {{0.5, 0.5, -0.5, 1}, color,  {1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0}, {1, 1}},
            {{0.5, 0.5, 0.5, 1}, color,  {1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0}, {0, 1}},
            ...
            // bottom face
            {{-0.5, -0.5, 0.5, 1}, color, {0.0f, -1.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {0, 1}},
            {{-0.5, -0.5, -0.5, 1}, color, {0.0f, -1.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {0, 0}},
            {{0.5, -0.5, -0.5, 1}, color, {0.0f, -1.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {1, 0}},
            {{0.5, -0.5, 0.5, 1}, color, {0.0f, -1.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {1, 1}},
