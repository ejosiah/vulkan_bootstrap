...
Vertices primitives::cube(const glm::vec4& color){
    Vertices mesh;
    mesh.vertices = {
            {{-0.5f, -0.5f, 0.5f, 1.0f}, color, {0.0f, 0.0f, 1.0f}, {0, 0, 0}, {0, 0, 0}, {0.0f, 0.0f}},
            {{0.5f, -0.5f, 0.5f, 1.0f}, color,  {0.0f, 0.0f, 1.0f}, {0, 0, 0}, {0, 0, 0}, {1.0f, 0.0f}},
            {{0.5f,  0.5f, 0.5f, 1.0f}, color,  {0.0f, 0.0f, 1.0f}, {0, 0, 0}, {0, 0, 0}, {1.0f, 1.0f}},
            {{-0.5f,  0.5f, 0.5f, 1.0f}, color,  {0.0f, 0.0f, 1.0f}, {0, 0, 0}, {0, 0, 0}, {0.0f, 1.0f}},

            {{ 0.5f, -0.5f, 0.5f, 1.0f}, color,  {1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0}, {0.0f, 0.0f}},
            {{0.5f, -0.5f, -0.5f, 1.0f}, color,  {1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0}, {1.0f, 0.0f}},
            {{0.5f,  0.5f, -0.5f, 1.0f}, color,  {1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0}, {1.0f, 1.0f}},
            {{0.5f,  0.5f, 0.5f, 1.0f}, color,  {1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0}, {0.0f, 1.0f}},
            ...
            {{-0.5, -0.5, 0.5, 1.0f},  color, {-1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {0.0f, 0.0f}},
            {{-0.5f,  0.5f, 0.5f, 1.0f}, color, {-1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {1.0f, 0.0f}},
            {{-0.5f,  0.5f, -0.5f, 1.0f}, color, {-1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {1.0f, 1.0f}},
            {{-0.5f, -0.5f, -0.5f, 1.0f}, color, {-1.0f, 0.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {0.0f, 1.0f}},

            {{-0.5f, -0.5f, 0.5f, 1.0f}, color, {0.0f, -1.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {0.0f, 0.0f}},
            {{-0.5f, -0.5f, -0.5f, 1.0f}, color, {0.0f, -1.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {1.0f, 0.0f}},
            {{0.5f, -0.5f, -0.5f, 1.0f}, color, {0.0f, -1.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {1.0f, 1.0f}},
            {{0.5f, -0.5f, 0.5f, 1.0f}, color, {0.0f, -1.0f, 0.0f}, {0, 0, 0}, {0, 0, 0},  {0.0f, 1.0f}},
